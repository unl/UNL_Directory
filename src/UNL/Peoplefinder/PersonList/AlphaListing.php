<?php
class UNL_Peoplefinder_PersonList_AlphaListing extends AppendIterator
{
    ...
    function __construct($options = array())
    {
        ...
        $range = range('a', 'z');
        foreach ($range as $begins_with) {
            $results = $pf->getAdvancedSearchMatches(array('sn'=>$begins_with, 'cn'=>''), 'faculty');
