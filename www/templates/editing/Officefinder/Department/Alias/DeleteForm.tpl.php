<form action="<?php echo $parent->parent->context->getURL(); ?>" method="post" id="deletealias_<?php echo $context->department_id.$context->name; ?>" class="delete">
	...
	<button class="icon-trash" type="submit" onclick="if (!confirm('Are you sure? This will delete the alias.')) return false;"><span class="wdn-text-hidden">Delete</span></button>
</form>
