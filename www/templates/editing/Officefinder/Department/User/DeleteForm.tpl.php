<form action="<?php echo $parent->parent->context->getURL(); ?>" method="post" id="deleteuser_<?php echo $context->department_id.$context->uid; ?>" class="delete">
    ...
    <button class="icon-trash wdn-button-brand" type="submit" onclick="if (!confirm('Are you sure? This will remove editing access for this user.')) return false;"><span class="wdn-text-hidden">Delete</span></button>
</form>
