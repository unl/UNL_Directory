<a href="#" onclick="if (confirm('Are you sure? This will remove editing access for this user.')) document.getElementById('deleteuser_<?php echo $context->department_id.$context->uid; ?>').submit();">Delete</a>
