...
<nav class="dcf-pagination">
    <ol class="dcf-list-bare dcf-list-inline">
        ...
        <?php for ($page = 1; $page*$context->limit < $context->total+$context->limit; $page++ ) {
            $link = $context->url.AMP_LIMIT.$context->limit.AMP_OFFSET.($page-1)*$context->limit;
            $currentPage = false;
        ...
        <li><a class="dcf-pagination-next" href="<?php echo $context->url.AMP_LIMIT.$context->limit.AMP_OFFSET.($context->offset+$context->limit); ?>">Next</a></li>
        <?php endif; ?>
    </ol>
</nav>
