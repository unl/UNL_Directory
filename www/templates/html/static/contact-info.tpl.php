<nav id="dcf-footer-group-1" role="navigation" aria-labelledby="dcf-footer-group-1-heading">
  ...
  <p><a href="<?php echo UNL_Peoplefinder::getURL() . 'help/' ?>"><span class="wdn-icon-info" aria-hidden="true"></span>Directory Help</a></p>
  <p><a href="http://wdn.unl.edu/documentation/unl-directory"z<span class="wdn-icon-rocket" aria-hidden="true"></span>Developer Documentation</a></p>
