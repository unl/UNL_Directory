<form method="get" id="peoplefinder" action="<?php echo UNL_Peoplefinder::getURL(); ?>" class="directorySearch first">
    ...
    <div class="input-group">
        <input type="text" autofocus placeholder="Enter a name" value="<?php echo $default; ?>" id="q" name="q" title="Enter a name to begin your search" class="q" />
    ...
    <ul id="directoryHelp">
        ...
        <li>
            <a href="http://www.unl.edu/ucomm/splash/fieldguide_directory.shtml" title="Find out what's new in the directory" class="wdn-button">Help</a>
        </li>
    </ul>
</form>
